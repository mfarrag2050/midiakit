// **@legacy** — drawAt الموروث: دالة خالصة من الزمن إلى إطار.
//
// **الحالة (2026-09-02):** أُعلن @legacy عند بدء المرحلة 3.7. يبقى
// المصدر الأوحد للحقيقة في مخرج الفيديو حتى ينتج timeline-v2 نفس
// المخرج بايت-بايت. `scripts/verify-timeline-equivalence.mjs` يحكم.
//
// **العماد المعماري (ADR-004):** لا حالة متراكمة بين الاستدعاءات.
// `drawAt(t=1.4)` بعد `drawAt(t=5.7)` **يجب** أن يعطي نفس نتيجة
// `drawAt(t=1.4)` معزولاً.
//
// **البنية:**
 ...
 */
/** @legacy — راجع تعليق أعلى الملف. المصدر الأوحد للفيديو حتى تجتاز timeline-v2 بوابة التكافؤ. */
