...
export interface TrackItem {
  ...
  /**
   * mk/467 — عاملُ إزاحةِ حجم الخط. القيم المسموحة **فقط**: `0.8` · `1.0`
   * · `1.2` (ثلاث درجات لا رقمٌ حرّ). قيمةٌ خارج المجموعة ⇒ رمي عند
   * `prepareTextItem` يسمّي القطعةَ والقيمة. غائبٌ ⇒ `1` ⇒ صفرُ تغيّرٍ
   * في أيِّ لقطةٍ قائمة.
   *
   * **لماذا مغلَق:** المُحسِّنُ يختار fs الأفضل داخل مدًى. رقمٌ حرٌّ
   * يعطّله فتعود الكشيدةُ المفرطةُ والحرفُ اليتيم (قِيسا في mk/462).
   * الدرجاتُ الثلاث تُزيح المدى دون تعطيلِ المُحسِّن.
   */
