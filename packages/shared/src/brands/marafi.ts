...
//
// ── قرار تحريريّ · واقعٌ مقيس (_AMEND-300c) ───────
// الأحمر (`#B3261E`) **محصور في بادج «عاجل» فعلاً**. قياس على لقطات
// مَرافئ الحاليّة بعد إصلاح _AMEND-300b (`urgentBg: SURFACE`):
//
//   بكسلات URGENT (#B3261E ±25) في ع1/ع2/ع3-feed (1080×1350):
//     8,930 px = 0.61% من كلّ لقطة · نطاق y=549–614 (65px ارتفاع).
//     الموقع يطابق موضع بادج «عاجل» (top-right).
//
// **الوصف يتبع الشيفرة، لا العكس** (نصّ owner في _AMEND-300c §٤).
// تحرّي mkau (550) قِست حالة قديمة قبل _AMEND-300b (كان urgentBg=URGENT
// يغطّي fallback خلفيّة كامل البطاقة). الإصلاح جعل urgentBg=SURFACE،
// فانحصر URGENT في البادج كما تنصّ النيّة الأصليّة.
//
// إن وجدتَ الأحمر خارج بادج «عاجل» في لقطات مستقبليّة، **قِس أوّلاً**
// (`scripts/300c-measure-red.mjs`) قبل تعديل الشيفرة أو التعليق.
...
const URGENT   = '#B3261E'; // بادج «عاجل» (مقيس 0.61% من اللقطة · y=549–614)
