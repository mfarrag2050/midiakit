...
export interface PlacementSpec {
  ...
  /**
   * محاذاة أفقيّة تُستعمل حين يكون الأنكور **بنيويّاً** (مشتقٌّ من طبقة
   * أخرى، لا من الشاشة). حاليّاً: `SourceLayer` بأنكور `'below-headline'`
   * يقرأ هذا الحقل ليحاذي السطر إلى الحافّة اليسرى أو اليمنى أو مركز
   * كتلة العنوان — لا حافّة اللوحة. الأنكور الشاشيّ يُستمدّ من `anchor`
   * أعلاه، ولا يحتاج هذا الحقل. الافتراضي على `source`: `'left'`
   * (99G-SOURCE-LEFT · 2026-09-12 · قرار المالك).
   */
