...
**آخر تحديث:** 2026-09-01 (المرحلة 3.5 الجزء ب-2 — الموارد الخارجية).
...
**بوابات (ج، د، أداء) اجتازت:** Δfill=+0.56%، Δstddev=-0.26%، softness
regression=2.26%، p95=402ms. **بوابتا (أ) و (ب) معلَّقتان** حتى وصول
WojoodGaza (نموذج طلب أكاديمي عبر sina.birzeit.edu).
...
### الجزء (ب-2) — الموارد الخارجية (2026-09-01 ◐)
