...
**آخر تحديث:** 2026-09-02 (المرحلة 3.7 — محرّك الخط الزمني ☑، الواجهة تنتقل إلى 4).
...
**التالي:** مسح ميزات منهجي (بند مؤجَّل — قبل المرحلة 4) · إغلاق دَين
المرحلة 3.5 عند وصول WojoodGaza · ثم المرحلة 4 (المنصة + واجهة الخط
الزمني + `brand.locale` + سجل التصديرات).
