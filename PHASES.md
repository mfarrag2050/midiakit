...
(امتدادات المحرك — 2026-09-04: الإسناد ☑ · التفريغ ☑ (skeleton خدمة + طبقة caption محرك) · Lottie 🔻 مؤجَّل بشرط · SVG ☑ (6 بوابات) · كشف الوجوه ☑ (خدمة MTCNN معزولة + smart-crop في المحرك، 6 بوابات) · التعليق الصوتي ☑ (packages/tts BYO-key + mock adapter، 6 بوابات)).**
