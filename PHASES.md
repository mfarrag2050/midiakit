...
SVG ☐ (2026-09-03، رُقّي من المؤجَّل)، كشف الوجوه ☐، التعليق الصوتي ☐).**
...
- ☐ **SVG + محرّكنا (المسار ب)** — قرار المالك 2026-09-03: يُبنى بكل
      تبعاته (كان مؤجَّلاً مع Lottie، أُلغي التأجيل). SVG ثابت أو
      متحرَّك بمحرّكنا الخاص — لا Skottie ولا محرّك رسم ثانٍ، على القيود
      نفسها (Canvas 2D، نقاء drawAt، تكامل مع `Track` و `AudioPlan`).
      يسدّ فجوة Lottie جزئياً بلغة أبسط وحرية توسّع أوسع. راجع
      `docs/12 §4` لتفصيل المسار.
