...
| 4 | المنصة | 5–6 أسابيع | عميل يعمل ذاتياً | ☐ |
| 5 | النمو | مستمر | — | ☐ |
...
- ☐ **Lottie / Skottie — الموشن جرافيك** — طبقة `lottie` كنوع
      ...
      التحقق من إتاحة Skottie في `skia-canvas` المُثبَّت عندنا (قد
      يحتاج بناءً مخصصاً). البديل الجاهز: `lottie-nodejs` + `node-canvas`.
      **فحص رخصة كلا المسارين أولاً**. المسار (ب) — SVG + محرّكنا —
      يبقى مؤجَّلاً كما هو في docs/12.
