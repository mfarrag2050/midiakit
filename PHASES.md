...
**قبل رفع `docs/SKILL-mediakit.md` إلى واجهة Claude:** شغّل
`pnpm skill:publish` (يبني السكيل ثم يفحص طزاجته). الفحص خارج
سلسلة `test` لأنه يقيس طزاجة مخرَج خارجي لا سلامة الشجرة، ويربط
`main` بحركة فرعَين لا يملكهما.
