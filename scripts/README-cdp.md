...
| `cdp-reels.mjs` | reels/454→456→458 — محرّر الخطّ الزمني على `/dev/reels` (mock-free): عرض · تحديد · سحب ماوس فعليّ عبر أحداث CDP (+٥ ث) · شطر عند رأس القراءة باختصار S · أرقام عربية-هندية · زوم وتمرير (⌘+عجلة وأزرار ولوحة مفاتيح) مع إثبات هندسيّ لعرض قطعة عند مستويَي زوم — وتحقّق هندسة DOM بعد كلّ خطوة | `claude/reports/458-shots/` (أو argv[2]): `reels-01-idle.png` · `reels-02-selected.png` · `reels-03-after-drag.png` · `reels-04-after-split.png` · `reels-05-arabic-digits.png` · `reels-06-zoomed.png` |
